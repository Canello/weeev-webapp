...
export const CreateIdea = () => {
    ...
    const [requestCreateIdea, idea, isFetchingIdea, createIdeaError] =
        useFetch();
    ...
    return (
        <main className="CreateIdea page">
            <form>
                <Spacer dir="y" size="xl" />
                <p className="font-body-2 color-n-30">
                    É só completar a frase e criar a ideia.
                    <br />
                    Aí você pode compartilhar o link pra saber quem também tá
                    afim.
                </p>
                <Spacer dir="y" size="m" />
                ...
                <Input
                    value={title}
                    setValue={setTitleAndRemoveError}
                    placeholder="...fazer alguma coisa"
                    maxLength={70}
                    error={titleError}
