...
export const LandingPage = () => {
    ...
    const onClickCreateIdea = () =>
        user ? goToCreateIdea() : openLoginPopUp();

    return (
        <main className="LandingPage page">
            <Spacer dir="y" size="xl" />
            <h1 className="font-headline-mobile-3 color-n-20">
                Reúna amigos para agitar um rolê
            </h1>
            <Spacer dir="y" size="l" />
            <StepByStep />
            <Spacer dir="y" size="xl" />
